...
import MockTradePreviousRoundMolecule from '@src/components/molecules/MockTradePreviousRoundMolecule/MockTradePreviousRoundMolecule';



export default function MockTradePreviousRoundPrice() {
  const navigation = useNavigation();
 
  const previousRoundRenderItem = ({item}:{item:any}) => (
    <MockTradePreviousRoundMolecule item={item} />
  );
  return (
