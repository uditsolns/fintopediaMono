...
import styles from "./SaveforLaterMolecule.module.css";
      ...
      <Card className={`${styles.courseCard}`}>
        ...
        <div className={styles.cardBody}>
          ...
          >
            ...
            <span>({course.course?.reviews} reviews)</span>
          </div>
          <div className={styles.featurePriceContainer}>
            <h3>&#8377;{course.course?.sale_price}</h3>
            <s>&#8377;{course.course?.actual_price}</s>
            {/* <button
...
export default SaveforLaterMolecule;
