    ...
    <React.Fragment>
      <div className="privacy-policy-header">
        <div className="privacy-policy-content">
          ...
          <p> 
            1. Terms & Conditions This document is an electronic record in terms
          ...
          <p>
            ...
            https://fintopedia.com (‘Website’), including the related mobile
            site and mobile application (hereinafter referred to as ‘Platform’).
          </p>
          <p>
            3. The Platform is owned by <b>ZIVATECH EDPLOY VENTURES LLP</b>, a
            company incorporated under the Companies Act, 1956 with its
            registered office at{" "}
            <b>
              B 163, Sita Sadan Sky Build Village, Opp Sai Baba Nagar, Bihind
              Bhatia High School, Mumbai Kandivali West ,Mumbai ,India
            </b>
          ...
          <p>
            3.Your use of our Services and the Platform is solely and entirely
          ...
          <p>
            4. The contents of the Platform and the Services are proprietary to
          ...
          <p>
            7. You agree not to use the Platform and/ or Services for any
          ...
          <p>
            9. You understand that upon initiating a transaction for availing
            the Services you are entering into a legally binding and enforceable
            contract with the Platform Owner for the Services..
          </p>
          <p>
            10. You shall indemnify and hold harmless Platform Owner, its
          ...
          <p>
            11. Notwithstanding anything contained in these Terms of Use, the
          ...
          <p>
            13. All disputes arising out of or in connection with these Terms
            shall be subject to the exclusive jurisdiction of the courts in
            <b>Mumbai and Maharashtra.</b>
          </p>
          <p>
