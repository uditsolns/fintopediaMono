      ...
      <div className="privacy-policy-header">
        <div className="privacy-policy-content">
          ...
          <p className="privacy-paragraph">
            ...
            <b>ZIVATECH EDPLOY VENTURES LLP</b> and its affiliates (collectively
            “<b>ZIVATECH EDPLOY VENTURES LLP</b>, we, our, us”) collect, use,
            share, protect or otherwise process your information/ personal data
            through our website https://fintopedia.com (hereinafter referred to
          ...
          <p className="privacy-paragraph">
            ...
            <b>ZIVATECH EDPLOY VENTURES LLP</b> seeking any personal data like
          ...
          <div className="mt-3">
            ...
            <p>Designation: Insert Name and Address of the Company:</p>
            <p>Contact us:</p>
            <p>Phone: 022-46017175</p>
