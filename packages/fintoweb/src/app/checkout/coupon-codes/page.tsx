  ...
  const couponCodes: CouponCode[] = [
    {
      ...
      conditions: "On all finance courses",
      code: "FIRST10",
      expiryDate: "Valid till 30th July",
    },
    {
      discount: "Extra 10% Off",
      conditions: "On all finance courses",
    ...
    <div className={styles.drawerBackdrop}>
      <div className={styles.drawer}>
        <div className={styles.drawerHeader}>
          <h2>Coupon codes</h2>
          {/* <X className={styles.closeIcon} onClick={() => setIsOpen(false)} /> */}
          <svg
          ...
          {couponCodes.map((coupon, index) => (
            <div key={index} className={styles.couponItem}>
              <div className={styles.couponHeader}>
                ...
                <small className={styles.expiryDate}>{coupon.expiryDate}</small>
              </div>
              <div className={styles.discount}>
                <h3>{coupon.discount}</h3>
                <small>{coupon.conditions}</small>
              </div>
