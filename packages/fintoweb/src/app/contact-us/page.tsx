...
const Contact: React.FC = () => {
  ...
  const items = [
    { title: "Why opt for an online options trading course?", content: "Content for section 1" },
    { title: "Is this Option Trading Course in Hindi language?", content: "Content for section 2" },
    { title: "Does this course cover advanced options trading strategy?", content: "Content for section 3" },
    { title: "Does this course cover advanced options trading strategy?", content: "Content for section 3" },
    { title: "Does this course covers option buying and options selling?", content: "Content for section 3" },
    { title: "Is this Option Trading Course in Hindi language?", content: "Content for section 3" },
